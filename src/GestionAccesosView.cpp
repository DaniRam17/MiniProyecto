...
#include "../include/ListVisualizer.h" // ✅ nuevo include
...
void mostrarVistaGestionAccesos(Font& fuente, HashTable& tabla) {
    ...
    Color colorLimpiar(168, 85, 247), colorLimpiarHover(147, 51, 234); // Color morado para limpiar

    int spacingY = 55;
    int posX = 40;
    int anchoInput = 280; //anchoinput
    int botonCol1X = 400, botonCol2X = 680; //posicion x botones 
    int botonWidth = 240, botonHeight = 45; //altura y posicones
    ...
    int resultadoX = 50;
    int resultadoY = 480; // Posición entre botones y mensaje de salida
    ...
    while (ventana.isOpen()) {
            ...
            if (e.type == Event::MouseButtonPressed && e.mouseButton.button == Mouse::Left) {
                ...
                if (clicEn(botonBuscar)) {
                    ...
                    if (u) {
                        ...
                        // ✅ CAMBIO: Mostrar resultados en los cuadros especiales en lugar de los inputs
                        ...
                        // Limpiar resultados si no se encuentra
                        resultadoId.setTexto("");
                        resultadoNombre.setTexto("");
                        resultadoCorreo.setTexto("");
                    }
                ...
                accesosVisibles = tabla.obtenerAccesosVisuales(u->getId());
                 ...
                 // Mostrar resultados en los cuadros especiales
                resultadoId.setTexto(to_string(u->getId()));
                resultadoNombre.setTexto(u->getNombre());
                resultadoCorreo.setTexto(u->getCorreo());
                 } else {
                ...
                accesosVisibles.clear();
                    ...
                    if (tabla.insertarUsuario(nuevo)) {
                        ...
                        // Mostrar el usuario recién registrado en los resultados
                    ...
                    if (tabla.eliminarUsuarioPorId(id)) {
                        ...
                        salida.setFillColor(colorExito);
                        accesosVisibles.clear();
                        // Limpiar resultados ya que el usuario fue eliminado
                        resultadoId.setTexto("");
                        resultadoNombre.setTexto("");
                        resultadoCorreo.setTexto("");
                    } else {
                    ...
                    // ✅ Mostrar ventana gráfica de accesos
                    ...
                    // ✅ Mostrar ventana gráfica de usuarios
                    mostrarListaUsuarios(fuente, usuariosVisuales);
                }
                // ✅ NUEVO: Manejar clic en botón limpiar
        ...
        // ✅ Dibujar título y cuadros de resultados
        ...
        ventana.draw(sombraLimpiar); // ✅ Nueva sombra
        ...
        ventana.draw(botonLimpiar); ventana.draw(txtLimpiar); // ✅ Nuevo botón
